...
type
  TFOrdemManutencaoRelatorio = class(TUniFrame)
    ...
    fdOrdManutDetalhecodOrdemManutencao: TIntegerField;
    ...
    fdOrdManutDetalhecodBanco: TIntegerField;
    fdOrdManutDetalheagencia: TStringField;
    fdOrdManutDetalhecontaCorrente: TStringField;
    fdOrdManutDetalhedthrPrevManutencao: TSQLTimeStampField;
    fdOrdManutDetalhenomeTecnicos: TStringField;
    fdOrdManutDetalhedescAtividadesExecutadas: TStringField;
    fdOrdManutDetalhenomeSolicitante: TStringField;
    fdOrdManutDetalhedescricaoSolicitacaoManut: TStringField;
    fdOrdManutDetalhelocalManutencao: TStringField;
...
begin
  ...
  if fdOrdManutDetalhe.IsEmpty then begin
    fdOrdManutDetalhe.Close;
    MessageDlg('Nenhum registro de OS encontrado para a seleção informada!',mtError,[mbOK],nil);
    Exit;
  end;
