    ...
    try
      ...
      if sAcao = 'DELETE' then begin
        ...
        if dsRegistros.State = dsInsert then begin
          ...
          fqFKTab.Active := True;
          if not fqFKTab.IsEmpty then begin
            Result := Result + 'Código ' + dsRegistros.FieldByName('codOrdemServico').AsString + ' já está cadastrado! |';
          end;
        end;
        ...
        if (dsRegistros.FieldByName('tipoPreco').AsInteger = 0 ) or
          ...
          Result := Result + 'Tipo Preço deve ser informada! |';
        end;
        ...
        fqFKTab.Active := True;
        if fqFKTab.IsEmpty then begin
          Result := Result + 'Operador informado ' + dsRegistros.FieldByName('codOperador').AsString + ' não encontrado! |';
        end;
    ...
    try
      ...
      for I := 0 to mtDuplic.RecordCount - 1 do begin
        ...
        //with UniMainModule do begin
          ...
          UniMainModule.fdTitulosMovtoAReceberdescricao.AsString          := 'Implantação';
