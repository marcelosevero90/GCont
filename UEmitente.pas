...
begin
  ...
  if Column.FieldName = 'FC_IMG_DEL' then begin
    ...
    MessageDlg('Tem certeza que deseja eliminar o Endereço abaixo?' + chr(10) + fdEmitenteEnderecocodLocal.AsString  ,mtConfirmation,mbYesNo, pDeleteEnderecoConfirmar);
...
begin
  ...
  if DataSet.FieldByName('padrao').AsInteger = 1 then
    ...
    DataSet.FieldByName('FC_DSC_PADRAO').AsString := 'Não';
