object FItem: TFItem
    ...
    object tsLista: TUniTabSheet
      ...
      object dbLista: TUniDBGrid
        ...
        Columns = <
          ...
          item
            FieldName = 'FC_NOME_FAM'
            Title.Caption = 'Descri'#231#227'o Fam'#237'lia'
            Width = 155
            Sortable = True
          end
          item
          ...
          item
            FieldName = 'FC_DSC_TPCONT'
            Title.Caption = 'Tipo Controle'
            Width = 145
            Sortable = True
          end
          item
    ...
    object tsManut: TUniTabSheet
      ...
      object sbManut: TUniScrollBox
        ...
        object UniDBLookupComboBox1: TUniDBLookupComboBox
          ...
          Hint = ''
          ListField = 'descricao'
          ListSource = dsItemFamilia
          KeyField = 'codItemFamilia'
          ListFieldIndex = 0
          DataField = 'codItemFamilia'
          DataSource = dsItem
          TabOrder = 6
          Color = clWindow
        end
  ...
  object fdItem: TFDQuery
    ...
    object fdItemFC_IMG_EDIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EDIT'
      Size = 50
    end
    object fdItemFC_IMG_VIS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_VIS'
      Size = 50
    end
    object fdItemFC_IMG_DEL: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_DEL'
      Size = 50
    end
    object fdItemFC_NOME_FAM: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_NOME_FAM'
      Size = 100
    end
    object fdItemFC_DSC_TPCONT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_DSC_TPCONT'
    end
    object fdItemFC_DSC_SIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_DSC_SIT'
    end
  ...
  object fdItemFamilia: TFDQuery
    Connection = UniMainModule.conexaoDB
    SQL.Strings = (
      'select * from gcItemFamilia')
    Left = 564
    Top = 328
    object fdItemFamiliacodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdItemFamiliacodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdItemFamiliacodItemFamilia: TIntegerField
      FieldName = 'codItemFamilia'
      Origin = 'codItemFamilia'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdItemFamiliadescricao: TStringField
      FieldName = 'descricao'
      Origin = 'descricao'
      Required = True
      Size = 50
  ...
  object dsItemFamilia: TDataSource
    DataSet = fdItemFamilia
    Left = 644
    Top = 373
  end
  object fdUn: TFDQuery
    Connection = UniMainModule.conexaoDB
    SQL.Strings = (
      'select gcUnidMedida.*,'
      'concat(un, '#39' - '#39', descricao) as unDescricao'
      ''
      'from gcUnidMedida')
    Left = 604
    Top = 173
    object fdUncodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdUncodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdUnun: TStringField
      FieldName = 'un'
      Origin = 'un'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object fdUndescricao: TStringField
      FieldName = 'descricao'
      Origin = 'descricao'
      Required = True
      Size = 50
    end
    object fdUnunDescricao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'unDescricao'
      Origin = 'unDescricao'
      ProviderFlags = []
      ReadOnly = True
      Size = 63
