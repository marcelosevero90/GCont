object FOrdemManutManutencao: TFOrdemManutManutencao
  Left = 0
  Top = 0
  Width = 1023
  Height = 748
      ...
      object UniScrollBox1: TUniScrollBox
        ...
        object sbManut: TUniScrollBox
          ...
          object lcBanco: TUniDBLookupComboBox
            ...
            Width = 267
            Hint = ''
            ListField = 'bancoConta'
            ListSource = dsEmitenteContasBancaria
            KeyField = 'codBanco'
            ListFieldIndex = 0
            DataField = 'codBanco'
            DataSource = dsOrdemManutencao
          ...
          object UniDBMemo2: TUniDBMemo
            ...
            Height = 72
            Hint = ''
            DataField = 'descricaoSolicitacaoManut'
            DataSource = dsOrdemManutencao
          ...
          object UniDBDateTimePicker1: TUniDBDateTimePicker
            ...
            Width = 267
            Hint = ''
            DataField = 'dthrPrevManutencao'
            DataSource = dsOrdemManutencao
            DateTime = 45481.674088148150000000
            DateFormat = 'dd/MM/yyyy'
            TimeFormat = 'HH:mm:ss'
            Kind = tUniDateTime
            TabOrder = 18
          ...
          object UniLabel16: TUniLabel
            ...
            Height = 13
            Hint = ''
            Caption = 'Previs'#227'o Manuten'#231#227'o:'
            TabOrder = 19
          end
          object rgTipoOrdem: TUniDBRadioGroup
            Left = 417
            Top = 64
            Width = 166
            Height = 102
        ...
        object pgMnManut: TUniPageControl
          Left = 0
          Top = 238
          Width = 1013
          Height = 451
          Hint = ''
          ActivePage = tsMnDadosGerais
          Align = alClient
          Anchors = [akLeft, akTop, akRight, akBottom]
          TabOrder = 1
          object tsMnDadosGerais: TUniTabSheet
            Hint = ''
            ...
            object UniLabel23: TUniLabel
              ...
              Height = 13
              Hint = ''
              Caption = 'Loca da Manuten'#231#227'o:'
              TabOrder = 4
            end
        ...
        object tsItensLista: TUniTabSheet
          ...
          object UniPanel4: TUniPanel
            ...
            object btXML: TUniBitBtn
              ...
              TabOrder = 5
              ScreenMask.Enabled = True
              ScreenMask.Message = 'Carregando XML...'
              OnClick = btXMLClick
            end
          end
      ...
      object UniGroupBox4: TUniGroupBox
        ...
        object UniPanel7: TUniPanel
          ...
          object UniLabel31: TUniLabel
            ...
            Height = 13
            Hint = ''
            Caption = 'Detalhamento Atividades Executadas:'
            ParentFont = False
            Font.Color = clNavy
            TabOrder = 3
          end
          object UniDBMemo3: TUniDBMemo
            ...
            Height = 68
            Hint = ''
            DataField = 'descAtividadesExecutadas'
            DataSource = dsOrdemManutencao
            ScrollBars = ssVertical
            TabOrder = 4
          end
  ...
  object dsOrdemManutencao: TDataSource
    DataSet = fdOrdemManutencao
    Left = 628
    Top = 288
  end
  ...
  object dsOrdemManutItem: TDataSource
    DataSet = fdOrdemManutItem
    Left = 764
    Top = 72
  end
  ...
  object fdOrdemManutencao: TFDQuery
    OnCalcFields = fdOrdemManutencaoCalcFields
    Indexes = <
      item
        Active = True
        Selected = True
        Name = 'idxOrdCodAsc'
        Fields = 'codOrdemManutencao'
      end>
    IndexName = 'idxOrdCodAsc'
    Connection = UniMainModule.conexaoDB
    SQL.Strings = (
      'select * from gcOrdemManutencao')
    Left = 540
    Top = 280
    object fdOrdemManutencaoFC_DSC_SIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_DSC_SIT'
    end
    object fdOrdemManutencaoFC_DSC_TIPO_ORDEM: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_DSC_TIPO_ORDEM'
    end
    object fdOrdemManutencaoFC_IMG_EDIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EDIT'
      Size = 50
    end
    object fdOrdemManutencaoFC_IMG_VIS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_VIS'
      Size = 50
    end
    object fdOrdemManutencaoFC_IMG_DEL: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_DEL'
      Size = 50
    end
    object fdOrdemManutencaoFC_NOME_EMITENTE: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_NOME_EMITENTE'
      Size = 100
    end
    object fdOrdemManutencaoFC_NOME_CIDADE: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_NOME_CIDADE'
      Size = 100
    end
    object fdOrdemManutencaoFC_NOME_FORMA_PAG: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_NOME_FORMA_PAG'
      Size = 100
    end
    object fdOrdemManutencaoFC_NOME_COND_PAG: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_NOME_COND_PAG'
      Size = 100
    end
    object fdOrdemManutencaoFC_NOME_MAQ_EQUIP: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_NOME_MAQ_EQUIP'
      Size = 100
    end
    object fdOrdemManutencaoFC_IMG_ITENS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_ITENS'
      Size = 100
    end
    object fdOrdemManutencaoFC_IMG_EFETIVA: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EFETIVA'
      Size = 100
    end
    object fdOrdemManutencaoFC_IMG_CANCELAOS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_CANCELAOS'
      Size = 100
    end
    object fdOrdemManutencaocodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdOrdemManutencaocodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdOrdemManutencaocodOrdemManutencao: TIntegerField
      FieldName = 'codOrdemManutencao'
      Origin = 'codOrdemManutencao'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdOrdemManutencaodescricao: TStringField
      FieldName = 'descricao'
      Origin = 'descricao'
      Required = True
      Size = 100
    end
    object fdOrdemManutencaoobservacao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'observacao'
      Origin = 'observacao'
      Size = 1000
    end
    object fdOrdemManutencaotipoOrdem: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'tipoOrdem'
      Origin = 'tipoOrdem'
    end
    object fdOrdemManutencaodataImplantacao: TDateField
      FieldName = 'dataImplantacao'
      Origin = 'dataImplantacao'
      Required = True
    end
    object fdOrdemManutencaovalorTotal: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'valorTotal'
      Origin = 'valorTotal'
      Precision = 15
    ...
    object fdOrdemManutencaosituacao: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'situacao'
      Origin = 'situacao'
    end
    object fdOrdemManutencaodataConclusao: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'dataConclusao'
      Origin = 'dataConclusao'
    end
    object fdOrdemManutencaocodEmitente: TIntegerField
      FieldName = 'codEmitente'
      Origin = 'codEmitente'
      Required = True
    end
    object fdOrdemManutencaocodFormaPagto: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'codFormaPagto'
      Origin = 'codFormaPagto'
    end
    object fdOrdemManutencaocodCondPagto: TIntegerField
      FieldName = 'codCondPagto'
      Origin = 'codCondPagto'
      Required = True
    end
    object fdOrdemManutencaocodMaqEquip: TIntegerField
      FieldName = 'codMaqEquip'
      Origin = 'codMaqEquip'
      Required = True
    end
    object fdOrdemManutencaomotivoCancelamento: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'motivoCancelamento'
      Origin = 'motivoCancelamento'
      Size = 100
    end
    object fdOrdemManutencaodataCancelamento: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'dataCancelamento'
      Origin = 'dataCancelamento'
    end
    object fdOrdemManutencaocodUsuarImplant: TStringField
      FieldName = 'codUsuarImplant'
      Origin = 'codUsuarImplant'
      Required = True
    end
    object fdOrdemManutencaocodUsuarCancelamento: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'codUsuarCancelamento'
      Origin = 'codUsuarCancelamento'
    end
    object fdOrdemManutencaocodPortador: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'codPortador'
      Origin = 'codPortador'
    end
    object fdOrdemManutencaocodUsuarConclusao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'codUsuarConclusao'
      Origin = 'codUsuarConclusao'
    end
    object fdOrdemManutencaocodBanco: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'codBanco'
      Origin = 'codBanco'
    end
    object fdOrdemManutencaoagencia: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'agencia'
      Origin = 'agencia'
    end
    object fdOrdemManutencaocontaCorrente: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'contaCorrente'
      Origin = 'contaCorrente'
    end
    object fdOrdemManutencaodthrPrevManutencao: TSQLTimeStampField
      AutoGenerateValue = arDefault
      FieldName = 'dthrPrevManutencao'
      Origin = 'dthrPrevManutencao'
    end
    object fdOrdemManutencaonomeTecnicos: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'nomeTecnicos'
      Origin = 'nomeTecnicos'
      Size = 500
    end
    object fdOrdemManutencaodescAtividadesExecutadas: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'descAtividadesExecutadas'
      Origin = 'descAtividadesExecutadas'
      Size = 5000
    end
    object fdOrdemManutencaonomeSolicitante: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'nomeSolicitante'
      Origin = 'nomeSolicitante'
      Size = 100
    end
    object fdOrdemManutencaodescricaoSolicitacaoManut: TStringField
      FieldName = 'descricaoSolicitacaoManut'
      Origin = 'descricaoSolicitacaoManut'
      Required = True
      Size = 5000
    end
    object fdOrdemManutencaolocalManutencao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'localManutencao'
      Origin = 'localManutencao'
      Size = 300
    end
  end
  object fdOrdemManutItem: TFDQuery
    OnCalcFields = fdOrdemManutItemCalcFields
    Indexes = <
      item
        Active = True
        Selected = True
    ...
    Connection = UniMainModule.conexaoDB
    SQL.Strings = (
      'select * from gcOrdemManutItem')
    Left = 660
    Top = 73
    object fdOrdemManutItemcodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdOrdemManutItemcodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdOrdemManutItemcodOrdemManutencao: TIntegerField
      FieldName = 'codOrdemManutencao'
      Origin = 'codOrdemManutencao'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdOrdemManutItemcodItem: TStringField
      FieldName = 'codItem'
      Origin = 'codItem'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdOrdemManutItempreco: TBCDField
      FieldName = 'preco'
      Origin = 'preco'
      Required = True
      Precision = 15
    ...
    object fdOrdemManutItemFC_IMG_EDIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EDIT'
      Size = 50
    end
    object fdOrdemManutItemFC_IMG_DEL: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_DEL'
      Size = 50
    end
    object fdOrdemManutItemFC_DESC_ITEM: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_DESC_ITEM'
      Size = 100
    end
    object fdOrdemManutItemobservacao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'observacao'
      Origin = 'observacao'
      Size = 500
    end
    object fdOrdemManutItemnrNotaFiscal: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'nrNotaFiscal'
      Origin = 'nrNotaFiscal'
    end
    object fdOrdemManutItemserieNF: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'serieNF'
      Origin = 'serieNF'
      Size = 5
  ...
  object fdEmitenteContasBancaria: TFDQuery
    Connection = UniMainModule.conexaoDB
    SQL.Strings = (
      'select gcEmitenteContasBancaria.*,'
      
        'concat(gcBanco.nomeBanco,'#39'-'#39',gcEmitenteContasBancaria.agencia,'#39'-' +
        #39',gcEmitenteContasBancaria.contaCorrente) as bancoConta'
      'from gcEmitenteContasBancaria'
      
        'inner join gcBanco on (gcEmitenteContasBancaria.codEmpresa = gcB' +
        'anco.codEmpresa'
      'and gcEmitenteContasBancaria.codEstabel = gcBanco.codEstabel'
      'and gcEmitenteContasBancaria.codBanco = gcBanco.codBanco)')
    Left = 776
    Top = 333
    object fdEmitenteContasBancariacodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdEmitenteContasBancariacodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdEmitenteContasBancariacodEmitente: TIntegerField
      FieldName = 'codEmitente'
      Origin = 'codEmitente'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdEmitenteContasBancariacodBanco: TIntegerField
      FieldName = 'codBanco'
      Origin = 'codBanco'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdEmitenteContasBancariaagencia: TStringField
      FieldName = 'agencia'
      Origin = 'agencia'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object fdEmitenteContasBancariacontaCorrente: TStringField
      FieldName = 'contaCorrente'
      Origin = 'contaCorrente'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object fdEmitenteContasBancariabancoConta: TStringField
      AutoGenerateValue = arDefault
  ...
  object dsEmitenteContasBancaria: TDataSource
    DataSet = fdEmitenteContasBancaria
    Left = 920
    Top = 333
  end
  ...
  object mtItensXML: TFDMemTable
    ...
    Left = 360
    Top = 268
    object mtItensXMLFC_EAN: TStringField
      FieldName = 'FC_EAN'
      Size = 25
    end
    object mtItensXMLFC_C_PROD: TStringField
      FieldName = 'FC_C_PROD'
      Size = 50
    end
    object mtItensXMLFC_V_PROD: TFloatField
      FieldName = 'FC_V_PROD'
    end
    object mtItensXMLFC_ITEM_EXISTE: TBooleanField
      FieldName = 'FC_ITEM_EXISTE'
    end
    object mtItensXMLcodItem: TStringField
      FieldName = 'codItem'
      Size = 25
    end
    object mtItensXMLFC_NF: TStringField
      FieldName = 'FC_NF'
    end
    object mtItensXMLFC_SERIE: TStringField
      FieldName = 'FC_SERIE'
      Size = 10
    end
  end
  object fdItXML: TFDQuery
    Indexes = <
      item
        Active = True
        Selected = True
    ...
    Left = 896
    Top = 156
    object fdItXMLcodEAN: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'codEAN'
      Origin = 'codEAN'
      Size = 25
    end
    object fdItXMLcodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdItXMLcodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdItXMLcodItem: TStringField
      FieldName = 'codItem'
      Origin = 'codItem'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object fdItXMLdescricao: TStringField
      FieldName = 'descricao'
      Origin = 'descricao'
      Required = True
      Size = 100
    end
    object fdItXMLcodItemFamilia: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'codItemFamilia'
      Origin = 'codItemFamilia'
    end
    object fdItXMLdataImplantacao: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'dataImplantacao'
      Origin = 'dataImplantacao'
    end
    object fdItXMLtipoControle: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'tipoControle'
      Origin = 'tipoControle'
    end
    object fdItXMLsituacao: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'situacao'
      Origin = 'situacao'
    end
    object fdItXMLun: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'un'
      Origin = 'un'
      Size = 10
    end
    object fdItXMLitemDesc: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'itemDesc'
      Origin = 'itemDesc'
      ProviderFlags = []
