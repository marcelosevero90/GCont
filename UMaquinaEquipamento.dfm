object FMaquinaEquipamento: TFMaquinaEquipamento
  Left = 0
  Top = 0
  Width = 928
  Height = 490
      ...
      object dbLista: TUniDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'M'#225'quina/Equipamento'
            Width = 604
            Sortable = True
          end>
      end
  ...
  object dsMaquinaEquip: TDataSource
    DataSet = fdMaquinaEquip
    Left = 628
    Top = 288
  end
  object fdMaquinaEquip: TFDQuery
    Indexes = <
      item
        Active = True
        Name = 'idxOrdCodAsc'
    ...
    IndexName = 'idxOrdCodAscidxOrdCodAsc'
    Connection = UniMainModule.conexaoDB
    SQL.Strings = (
      'select * from gcMaquinaEquipamento')
    Left = 484
    Top = 320
    object fdMaquinaEquipcodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdMaquinaEquipcodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdMaquinaEquipcodMaqEquip: TIntegerField
      FieldName = 'codMaqEquip'
      Origin = 'codMaqEquip'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdMaquinaEquipnomeMaqEquip: TStringField
      FieldName = 'nomeMaqEquip'
      Origin = 'nomeMaqEquip'
      Required = True
      Size = 100
    end
    object fdMaquinaEquipFC_IMG_EDIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EDIT'
      Size = 50
    end
    object fdMaquinaEquipFC_IMG_VIS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_VIS'
      Size = 50
    end
    object fdMaquinaEquipFC_IMG_DEL: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_DEL'
      Size = 50
    end
