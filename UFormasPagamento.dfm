object FFormasPagamento: TFFormasPagamento
      ...
      object dbLista: TUniDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'C'#243'digo Forma Pagto'
            Width = 172
            Sortable = True
          end
          item
            FieldName = 'nomeFormaPagto'
            Title.Caption = 'Nome Forma Pagto'
            Width = 413
            Sortable = True
          end>
      end
  ...
  object fdFormaPagto: TFDQuery
    ...
    object fdFormaPagtoFC_IMG_EDIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EDIT'
      Size = 50
    end
    object fdFormaPagtoFC_IMG_VIS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_VIS'
      Size = 50
    end
    object fdFormaPagtoFC_IMG_DEL: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_DEL'
      Size = 50
    end
