object FPortadorFinanceiro: TFPortadorFinanceiro
  Left = 0
  Top = 0
  Width = 1034
  Height = 538
  ...
  object pgMenu: TUniPageControl
    ...
    object tsLista: TUniTabSheet
      ...
      object gbFiltroParam: TUniGroupBox
        ...
        object edtBancoFiltro: TUniNumberEdit
          Left = 110
          Top = 31
          Width = 108
          Hint = ''
    ...
    object tsManut: TUniTabSheet
      ...
      object sbManut: TUniScrollBox
        ...
        object rbTipo: TUniDBRadioGroup
          Left = 186
          Top = 192
          Width = 185
          Height = 105
  ...
  object fdPortador: TFDQuery
    OnCalcFields = fdPortadorCalcFields
    Indexes = <
      item
        Active = True
        Selected = True
    ...
    object fdPortadorFC_IMG_EDIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EDIT'
      Size = 50
    end
    object fdPortadorFC_IMG_VIS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_VIS'
      Size = 50
    end
    object fdPortadorFC_IMG_DEL: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_DEL'
      Size = 50
    end
    object fdPortadorFC_NOME_BANCO: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_NOME_BANCO'
      Size = 100
    end
    object fdPortadorFC_DSC_TIPO: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_DSC_TIPO'
    end
  end
  object fdBanco: TFDQuery
    ...
    object fdBancoFC_IMG_EDIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EDIT'
      Size = 50
    end
    object fdBancoFC_IMG_VIS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_VIS'
      Size = 50
    end
    object fdBancoFC_IMG_DEL: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_DEL'
      Size = 50
    end
  end
  object fdBcoLista: TFDQuery
    Indexes = <
      item
        Active = True
        Selected = True
    ...
    Left = 780
    Top = 376
    object fdBcoListacodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdBcoListacodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdBcoListacodBanco: TIntegerField
      FieldName = 'codBanco'
      Origin = 'codBanco'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdBcoListanomeBanco: TStringField
      FieldName = 'nomeBanco'
      Origin = 'nomeBanco'
      Required = True
      Size = 50
