object FUnidadeMedida: TFUnidadeMedida
  ...
  object dsUnidMedida: TDataSource
    DataSet = fdUnidMedida
    Left = 628
    Top = 288
  end
  object fdUnidMedida: TFDQuery
    Indexes = <
      item
        Active = True
        Selected = True
    ...
    Connection = UniMainModule.conexaoDB
    SQL.Strings = (
      'select * from gcUnidMedida')
    Left = 348
    Top = 304
    object fdUnidMedidacodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdUnidMedidacodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdUnidMedidaun: TStringField
      FieldName = 'un'
      Origin = 'un'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object fdUnidMedidadescricao: TStringField
      FieldName = 'descricao'
      Origin = 'descricao'
      Required = True
      Size = 50
    end
    object fdUnidMedidaFC_IMG_EDIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EDIT'
      Size = 50
    end
    object fdUnidMedidaFC_IMG_VIS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_VIS'
      Size = 50
    end
    object fdUnidMedidaFC_IMG_DEL: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_DEL'
      Size = 50
    end
