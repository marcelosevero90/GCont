object FTitulosAPagarRelatorio: TFTitulosAPagarRelatorio
  Left = 0
  Top = 0
  Width = 1021
  Height = 532
    ...
    object tsLista: TUniTabSheet
      ...
      object UniToolBar1: TUniToolBar
        ...
        object btAtualizarDados: TUniBitBtn
          ...
          ScreenMask.Message = 'Imprimindo...Aguarde!'
          Images = UniNativeImageList1
          ImageIndex = 14
      ...
      object UniGroupBox1: TUniGroupBox
        ...
        Height = 454
        Hint = ''
        Caption = 'Filtro T'#237'tulos A Pagar'
        Align = alClient
        Anchors = [akLeft, akTop, akRight, akBottom]
        TabOrder = 1
        ...
        object gbSit: TUniGroupBox
          ...
          object cbCancelada: TUniCheckBox
            Left = 16
            Top = 47
            Width = 81
            Height = 17
  ...
  object fdTitulosAPagarLista: TFDQuery
    ...
    SQL.Strings = (
      ...
      'case '
      ''
      'when gcTitulosAPagar.situacao = 1 then '#39'Aberta'#39
      ''
      'when gcTitulosAPagar.situacao = 2 then '#39'Cancelada'#39
      ''
      'when gcTitulosAPagar.situacao = 3 then '#39'Liquidada'#39
      ''
      'else '#39#39' end as dscSit,'
    ...
    object fdTitulosAPagarListadscSit: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'dscSit'
      Origin = 'dscSit'
      ProviderFlags = []
