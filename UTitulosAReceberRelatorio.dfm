object FTitulosAReceberRelatorio: TFTitulosAReceberRelatorio
  Left = 0
  Top = 0
  Width = 1045
  Height = 538
  ...
  object fdTitulosAReceberLista: TFDQuery
    ...
    SQL.Strings = (
      ...
      'case '#10
      'when gcTitulosAReceber.situacao = 1 then '#39'Aberta'#39#10
      'when gcTitulosAReceber.situacao = 2 then '#39'Cancelada'#39#10
      'when gcTitulosAReceber.situacao = 3 then '#39'Liquidada'#39#10
    ...
    object fdTitulosAReceberListadscSit: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'dscSit'
      Origin = 'dscSit'
      ProviderFlags = []
