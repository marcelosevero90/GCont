...
type
  TFTitulosAPagarLiquidacao = class(TUniFrame)
    ...
    fdTitulosAPagarListacodOrdemManutencao: TIntegerField;
    ...
    try
      ...
      try
        ...
        for I := 0 to fdTitulosAPagarLista.RecordCount - 1 do begin
          ...
          fdTitulosMovtoAPagardescHistorico.AsString      := 'Liquidação' ;
          fdTitulosMovtoAPagardescricao.AsString          := 'Liquidação';
          fdTitulosMovtoAPagar.Post;
