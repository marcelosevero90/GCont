object FTitulosAPagarManutencao: TFTitulosAPagarManutencao
  Left = 0
  Top = 0
  Width = 965
  Height = 627
    ...
    object tsLista: TUniTabSheet
      ...
      object UniPanel5: TUniPanel
        ...
        object dbMovtos: TUniDBGrid
          ...
          Hint = ''
          TitleFont.Height = -8
          DataSource = dsTitulosMovtoAPagar
  ...
  object dsTitulosAPagar: TDataSource
    DataSet = fdTitulosAPagar
    Left = 628
    Top = 288
  end
  object fdTitulosAPagar: TFDQuery
    AfterScroll = fdTitulosAPagarAfterScroll
    OnCalcFields = fdTitulosAPagarCalcFields
    Indexes = <
      item
        Active = True
        Selected = True
    ...
    object fdTitulosAPagarcodOrdemServico: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'codOrdemServico'
