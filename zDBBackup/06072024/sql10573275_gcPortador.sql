...
CREATE TABLE `gcPortador` (
  ...
  KEY `chNome` (`codEmpresa`,`codEstabel`,`nomePortador`),
...
INSERT INTO `gcPortador` VALUES (1,0,2,'CAIXA',NULL,NULL,NULL,1,123.00,1000.00,0.00,0.00,0.00),(1,0,3,'BB 23423',3,'3423','23423',2,1000.00,2250.62,2.00,0.00,0.00);
...
-- Dump completed on 2024-07-06 16:46:45
