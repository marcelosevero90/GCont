...
CREATE TABLE `gcEmitente` (
  ...
  KEY `chCGC` (`codEmpresa`,`codEstabel`,`cgc`),
  KEY `chSit` (`codEmpresa`,`codEstabel`,`situacao`),
  KEY `chIdent` (`codEmpresa`,`codEstabel`,`situacao`),
  KEY `chDtImpl` (`codEmpresa`,`codEstabel`,`dataImplantacao`),
  KEY `chNome` (`codEmpresa`,`codEstabel`,`nomeEmitente`)
...
-- Dump completed on 2024-07-06 16:46:41
