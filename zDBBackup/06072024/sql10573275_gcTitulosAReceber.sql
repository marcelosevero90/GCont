...
CREATE TABLE `gcTitulosAReceber` (
  ...
  `motivoCancela` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`codEmpresa`,`codEstabel`,`codTituloAReceber`),
  KEY `chCli` (`codEmpresa`,`codEstabel`,`codEmitente`),
  KEY `chFormaPag` (`codEmpresa`,`codEstabel`,`codFormaPagto`),
  KEY `chSit` (`codEmpresa`,`codEstabel`,`situacao`),
  KEY `chPortad` (`codEmpresa`,`codEstabel`,`codPortador`),
  KEY `chOS` (`codEmpresa`,`codEstabel`,`codOrdemServico`),
  KEY `chEmit` (`codEmpresa`,`codEstabel`,`dtVencimento`)
...
INSERT INTO `gcTitulosAReceber` VALUES (1,0,1,'LLLLJHJHJ',1,1,9,'2024-06-30','2024-06-30','2024-06-30','ADMIN',NULL,55.00,55.00,NULL,NULL,NULL,2,'OS-3',1,3,NULL,NULL,NULL,NULL,1,0.00,0.00,0.00,NULL),(1,0,3,'NNNNNN',2,3,2,'2024-07-05','2024-07-04','2024-07-04','ADMIN',NULL,24.00,24.00,0.00,0.00,0.00,3,NULL,9,NULL,NULL,NULL,NULL,'ADMIN',1,2.00,0.00,0.00,'ddfgfdgdfg\r\n'),(1,0,4,'TETE1231',2,2,9,'2024-07-06','2024-07-05','2024-07-05','ADMIN',NULL,1231.00,1250.62,5.00,0.00,24.62,3,NULL,9,NULL,'ADMIN',NULL,'2024-07-05',NULL,1,2.00,0.00,0.00,NULL);
...
-- Dump completed on 2024-07-06 16:46:50
