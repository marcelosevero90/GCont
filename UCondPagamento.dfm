object FCondPagamento: TFCondPagamento
  Left = 0
  Top = 0
  Width = 984
  Height = 522
      ...
      object dbLista: TUniDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'N'#250'm Parcelas'
            Width = 131
            Sortable = True
          end>
      end
  ...
  object dsCondPagamento: TDataSource
    DataSet = fdCondPagamento
    Left = 628
    Top = 288
  end
  object fdCondPagamento: TFDQuery
    Indexes = <
      item
        Active = True
        Selected = True
    ...
    Left = 540
    Top = 296
    object fdCondPagamentocodEmpresa: TIntegerField
      FieldName = 'codEmpresa'
      Origin = 'codEmpresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdCondPagamentocodEstabel: TIntegerField
      FieldName = 'codEstabel'
      Origin = 'codEstabel'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdCondPagamentocodCondPagto: TIntegerField
      FieldName = 'codCondPagto'
      Origin = 'codCondPagto'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object fdCondPagamentonomeCondPagto: TStringField
      FieldName = 'nomeCondPagto'
      Origin = 'nomeCondPagto'
      Required = True
      Size = 50
    end
    object fdCondPagamentonumParcelas: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'numParcelas'
      Origin = 'numParcelas'
    end
    object fdCondPagamentotipoVencimento: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'tipoVencimento'
      Origin = 'tipoVencimento'
    end
    object fdCondPagamentoFC_IMG_EDIT: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_EDIT'
      Size = 50
    end
    object fdCondPagamentoFC_IMG_VIS: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_VIS'
      Size = 50
    end
    object fdCondPagamentoFC_IMG_DEL: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'FC_IMG_DEL'
      Size = 50
    end
